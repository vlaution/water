...
# Include routers
from backend.api import performance_routes, compliance_routes, audit_routes, excel_routes, risk_routes, validation_routes, feedback_routes, suggestion_routes, historical_routes
...
app.include_router(historical_routes.router) # Added historical_routes
app.include_router(risk_routes.router)
