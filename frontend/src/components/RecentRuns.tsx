...
export const RecentRuns: React.FC<RecentRunsProps> = ({ onSelectRun, token }) => {
    ...
    return (
        <div className="glass-panel p-6 animate-fade-in">
            <h3 className="text-lg font-bold text-gray-800 mb-4">Recent Runs</h3>
                ...
                <div className="space-y-3">
                    {runs.map((run) => (
                        <button
                            ...
                            className="w-full text-left p-4 bg-white/40 rounded-xl border border-white/30 hover:bg-white/60 transition-all hover:shadow-md group"
                        >
                            <div className="flex justify-between items-start mb-2">
                                <h4 className="font-semibold text-gray-900 group-hover:text-system-blue transition-colors">
                                    {run.company_name}
                                </h4>
