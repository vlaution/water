        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                <div className="flex flex-wrap gap-4 items-end">
                    <div>
                        <label className="block text-xs font-semibold text-gray-500 mb-1">Row Variable (Y-Axis)</label>
                        <select
                            value={rowVar}
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-gray-500 mb-1">Column Variable (X-Axis)</label>
                        <select
                            value={colVar}
                    ...
                    <button
                        onClick={runAnalysis}
                        disabled={isLoading}
                        className="bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center flex items-center gap-2 "
                    >
