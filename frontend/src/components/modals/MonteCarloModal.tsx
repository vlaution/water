...
export const MonteCarloModal: React.FC<MonteCarloModalProps> = ({ isOpen, onClose, baseData }) => {
                ...
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-blue-50 to-white rounded-t-xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">Risk Analysis & Outcome Distribution</p>
                        </div>
                    </div>
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={results.histogram}>
                                        ...
                                        <XAxis
                                            ...
                                            label={{ value: 'Enterprise Value', position: 'insideBottom', offset: -5 }}
                                        />
                                        <YAxis label={{ value: 'Frequency', angle: -90, position: 'insideLeft' }} />
                                        <Tooltip
                                            formatter={(value: number) => [value, 'Frequency']}
                                            labelFormatter={(label: number) => `Valuation > $${(label / 1e6).toFixed(1)}M`}
                                        />
